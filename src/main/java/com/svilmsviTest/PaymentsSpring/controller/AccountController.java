...
import com.svilmsviTest.PaymentsSpring.controller.dto.AccountRequestDTO;
import com.svilmsviTest.PaymentsSpring.controller.dto.AccountResponseDTO;
import com.svilmsviTest.PaymentsSpring.entity.Bill;
import com.svilmsviTest.PaymentsSpring.service.AccountService;
    ...
    public Long create(@RequestBody AccountRequestDTO accountRequestDTO){
        return accountService.save(accountRequestDTO.getName(),
                ...
                accountRequestDTO.getBills().stream()
                        .map(billRequestDTO -> new Bill(billRequestDTO.getAmount(), billRequestDTO
                                .getDefault())).collect(Collectors.toList()));
    }
}
